...
public class ShowAll extends Form {
    ...
    private void addGUIs() {
        ...
        searchTF = new TextField("", "Chercher produit par Description");
    ...
    private Container makeModelWithoutButtons(Produit Prod) {
        ...
        prixLabel = new Label("Prix : " + Prod.getPrix());
    ...
    private Component makeProduitModel(Produit prod) {
        ...
        Container prodModel = makeModelWithoutButtons(prod);
