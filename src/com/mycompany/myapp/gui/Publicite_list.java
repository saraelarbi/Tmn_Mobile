 ...
 * @author ffsga
 */
public class Publicite_list extends BaseForm{
    
     Form current;

    public Publicite_list(Resources res) {
        super("Publicites:", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        add(new Label("Ajouter Publicite"));
        getTitleArea().setUIID("Container");
        setTitle("List Publicites");
      ...
      //  addTab(swipe, s1, res.getImage("cat.png"), "", "", res);
       ...
       // rbs[0].setSelected(true);
        ...
        ArrayList<Publicite> ListPub = PubliciteService.getInstance().getAllPublicite();
        for (Publicite Pub : ListPub) {
    ...
    private void addButton(Image img, Publicite Pub,Resources res) {
        ...
        Label DatePubtxt = new Label("" + Pub.getDate_creation(), "NewsTopLine2");
        Label TitrePubtxt = new Label("" + Pub.getDomaine(), "NewsTopLine");
        Label DescPubtxt = new Label("" + Pub.getDescription(), "NewsTopLine");
        Label SourcePubtxt = new Label("" + Pub.getLettre_motivation(), "NewsTopLine");
//        Label CategoriePubtxt = new Label("" + Pub.getCategorie_Pub(), "NewsTopLine");
        ...
        if (Dialog.show("Suppression", "Vous Voulez Supprimer cet Publicite ? ", "Non", "Oui")) {
            dig.dispose();
        } else {
            dig.dispose();
            if(PubliciteService.getInstance().deletePublicite(Pub.getId_pub())){
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierPublicite(res,Pub).show();
        });
        ...
        cont.add(BorderLayout.CENTER, BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(lModifier, lsup)));
