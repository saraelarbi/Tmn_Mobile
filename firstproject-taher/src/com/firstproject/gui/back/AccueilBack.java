...
public class AccueilBack extends Form {
    ...
    private Button makeBlogsButton() {
        ...
        button.addActionListener(action -> new com.firstproject.gui.back.blog.ShowAll(this).show());
        return button;
    }
    ...
    private Button makeForumsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.firstproject.gui.back.forum.ShowAll(this).show());
        return button;
    }
